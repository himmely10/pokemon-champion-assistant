...
const SV = (0, util_1.extend)(true, {}, SS, PLA_PATCH, SV_PATCH, ZA_PATCH);
...
const CHAMPIONS_PATCH = {
    'Floette-Eternal': { otherFormes: ['Floette-Mega'] },
    'Floette-Mega': { baseSpecies: 'Floette-Eternal' },
};
const CHAMPIONS = (0, util_1.extend)(true, {}, Object.fromEntries(CHAMPIONS_LIST.map(s => [s, SV[s]])), CHAMPIONS_PATCH);
